    ...
    <div className="relative w-full h-[35vh] overflow-hidden">
      <div className="absolute">
        <div ref={slider} className="relative whitespace-nowrap">
          <h5 
            ref={firstText} 
            className="relative m-0 text-[#FF4E27] text-[230px] font-medium pr-12 inline-block"
          >
            Infrawave Solutions -
          </h5>
          <h5 
            ref={secondText} 
            className="absolute left-full top-0 m-0 text-[#FF4E27] text-[230px] font-medium pr-12"
          >
            Infrawave Solutions -
          </h5>
        </div>
