...
const Card = ({ color, i, Name, Desc, img, targetScale, progress, range }) => {
  ...
  return (
    <div
      className="md:h-[14.5vw] h-[47vh]  flex items-center justify-end  sticky top-[30vh] "
      style={{ color: "#fff" }}
      
    >
      <motion.div
        className="flex flex-col relative md:h-[350px] h-[550px] w-[100%]  origin-top  md:px-[1vw]  "
        style={{
