    ...
    <div>
      ...
      >
        <div className="w-full h-[80vh] fixed bottom-0 bg-pink-300">
          <footer className="bg-black text-neutral-300 h-full px-4 md:px-8 py-8 md:py-12 grid grid-cols-1 md:grid-cols-12 gap-8">
            {/* Logo and Socials */}
            <div className="md:col-start-1 md:col-end-4 flex flex-col gap-4">
              <h1 className="text-xl text-[#FF4E27] md:text-3xl font-semibold">Infrawave</h1>
